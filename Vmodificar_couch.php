<?php
	...
	$despublicado='0';
	$tipo=$_POST["tipo"];
	$sql= "UPDATE couch SET fecha='$fecha', titulo='$titulo', descripcion='$descripcion', ubicacion='$ubicacion', canthabitantes='$canthabitantes', cantpersonas='$cantpersonas', despublicado='$despublicado', idusuario='$idusuario', idtipo='$tipo' WHERE idcouch=$idcouch";
